...
class AppColors {
  static final Color textColor = const Color(0xFFccc3c5);
  static final Color mainColor = const Color(0xFFF44336);
  ...
  static final Color smokeColor = const Color(0xFFEDEDED);
}
